...
function createVideo(maxW, maxH, elW, elH, vid) {
    ...
    jQuery(".easy-opener-content").html('<a class="easy-opener-close" href="javascript:"><i class="linea-icon-arrows-remove"></i></a><iframe src="' + vid + '" width="' + elW + '" height="' + elH + '"></iframe>');
